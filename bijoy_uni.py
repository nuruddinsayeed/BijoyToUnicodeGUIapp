...
def render_in_gui():
    ...
    def clicked():
        ...
        converted_txt = convertBijoyToUnicode(res)
        out_txt.insert("1.0", converted_txt+"\n")
...
if __name__ == '__main__':
    # bi_text = "‡Kv‡bv †Kv‡bv w`b, AvKvk‡Rvov †gN K‡i, Kv‡R gb e‡m bv| †W‡¯‹i mvg‡bi Rvbvjvi c`©v Zz‡j w`B| w¯Œ‡b ZvKvB, †`wL bv, `‚ieZ©x AvKvk I Bgvi‡Z wKQz †LvuR _v‡K| Ggb me w`‡bi bvg †KvgjMvÜvi|"
    # while True:
    #     bi_text = input("\nEnter Bijoy Text here: ")
    #     uni_text = convertBijoyToUnicode(bi_text)
    #     print(f"{uni_text}")
    render_in_gui()